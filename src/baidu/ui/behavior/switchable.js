 ...
 * }.
 */
baidu.ui.behavior.switchable = function(options) {
    options = options || {};
    var me = this;
 ...
 * @param index 索引.
 */
baidu.ui.behavior.switchable.switchTo = function(index) {
    var me = this;
 ...
 */
baidu.ui.behavior.switchable.switchToTrigger = function(trigger) {
    var me = this,
        index = 0,
 ...
 * 切换到下一个元素
 */
baidu.ui.behavior.switchable.next = function() {
    var me = this;
 ...
 * 切换到上一个元素
 */
baidu.ui.behavior.switchable.prev = function() {
    var me = this,
 ...
 */
baidu.ui.behavior.switchable.getCurrent = function() {
    var me = this,
 ...
 * }
 */
baidu.ui.behavior.switchable._getEventArgs = function(fromIndex, toIndex) {
    var me = this;
    return {
        fromIndex: fromIndex,
...
// 绑定事件
baidu.ui.behavior.switchable.rebindTriggers = function() {
    var me = this;
...
// 解绑事件
baidu.ui.behavior.switchable.unbindTriggers = function() {
    var me = this;
    baidu.each(me._triggers, function(trigger) {
