 ...
 */
baidu.ui.carousel.Carousel.prototype._formatData = function(data) {
    var me = this,
 ...
 * @memberOf {TypeName}
 */
baidu.ui.carousel.Carousel.prototype.addTableItem = function(data, index) {
    var me = this, 
        table,
    ...
    if (dataArr.length > 0) {
        ...
        // 这时data的数据长度不是固定，me.data只记录有用的数据
        Array.prototype.splice.apply(me.data, 
            [insert * me.gridLayout.row * me.gridLayout.col, 0].concat(data));
 ...
 */
baidu.ui.carousel.Carousel.prototype.removeTableItem = function(index) {
    var me = this, 
        tab = me.getTable(index), 
        count = 0, 
        cells;
 ...
 * @return {TypeName} baidu.ui.table.Table.
 */
baidu.ui.carousel.Carousel.prototype.getTable = function(index) {
...
baidu.ui.carousel.Carousel.register(function(me) {
    if (me.data) {
        me.gridLayout = me.gridLayout ? 
            (baidu.lang.isArray(me.gridLayout) ? {row: me.gridLayout[0], col: me.gridLayout[1]} : me.gridLayout) : 
            {row: 3, col: 3};
