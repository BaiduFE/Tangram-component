...
baidu.ui.slider.Slider.extend({
    // 这里position如果没有设置，会造成该div和thumb之间掉行
     ...
     */
	  ...
	  _adjustProgressbar: function() {
	      var me = this,
	          layout = me.layout,
	          axis = me.axis[layout];
	      me.progressBar.getBar().style[me.progressBar.axis[layout].size] = 
            parseInt(baidu.dom.getStyle(me.getThumb(), axis.thumbPos), 10) + me[axis._getThumbSize]() / 2 + 'px';
	  }
});
