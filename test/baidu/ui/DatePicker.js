...
//		for(var index = 0; index <eles.length; index++){
	...
	test('click', function() {
		stop();
		var datePicker = new baidu.ui.DatePicker();
		var input = te.dom[0];
		datePicker.trigger = input;
		datePicker.popup = baidu.ui.DatePicker.popup;
		datePicker.render();
		datePicker.show();
		var date = new Date();
...
//			clickObj(currentTd);// 回到month层
			...
			equal(currentTd.innerHTML,
					datePicker.lang[baidu.ui.DatePicker.monthes[date
	...
	test('today', function() {
		...
		setTimeout(function() {
			...
			var datePicker = new baidu.ui.DatePicker(options);
			datePicker.popup = baidu.ui.DatePicker.popup;
			var input = te.dom[0];
			datePicker.trigger = input;
			datePicker.render();
	...
	test('options', function() {
		...
		setTimeout(function() {
			...
			var dp = new baidu.ui.DatePicker(options);
			var input = te.dom[0];
			dp.trigger = input;
			dp.popup = baidu.ui.DatePicker.popup;
			dp.render();
			dp.show();
