(function() {
	function createCarousel(c) {
		return carousel = new baidu.ui.carousel.Carousel(
				{
					target : c,
	...
	test('horizontal', function() {
		...
		setTimeout(function() {
			...
			carous.render();
			var offsetItem0 = document.getElementById(carous
		...
		setTimeout(function() {
			var options = {
				...
				"onafterscroll" : function() {
					...
					var item = document.getElementById(this.getId("item" + 2));
					this.focus(2);
					equals(item.offsetLeft, container.scrollLeft + 82 + offsetItem0,
							'scroll to item3');
					start();
				},
