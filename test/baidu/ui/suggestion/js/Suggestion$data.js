...
test("setData", function() {
	...
	sugg = new baidu.ui.suggestion.Suggestion(options);
	sugg.render(input);
	te.obj.push(sugg);
...
test("10 item", function() {
	...
	var datas = new Array(), sugg = new baidu.ui.suggestion.Suggestion( {
		onshow : function() {
			for ( var i = 0; i < 10; i++) {
...
test("overwrite data", function() {
	...
	var sugg = new baidu.ui.suggestion.Suggestion( {
		onshow : function() {
...
test('multi instance', function() {
	...
	sugg1 = new baidu.ui.suggestion.Suggestion({
		onshow : function() {
	...
	sugg2 = new baidu.ui.suggestion.Suggestion({
		onshow : function() {
