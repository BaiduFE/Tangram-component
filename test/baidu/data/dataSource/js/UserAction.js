UserAction = {
	...
	/***************************************************************************
	 * open a window from another html file alreay set a few parameters
	 * 
	 * @static
	 **************************************************************************/
	windowWithScroll : function() {
		return window.open(this.commonData.datadir + "test.html", "new",
				"height=400,width=400,toolbar=no,menubar=no,scrollbars=yes");
	},
	windowNoscroll : function() {
		return window.open(this.commonData.datadir + "test.html", "new",
				"height=400,width=400,toolbar=no,menubar=no,scrollbars=no")
	},
	...
	importsrc : function(src, callback, matcher) {
		/**
